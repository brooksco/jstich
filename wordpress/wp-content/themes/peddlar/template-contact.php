									...
									<?php if ( isset( $woo_options['woo_contact_panel'] ) && $woo_options['woo_contact_panel'] == 'true' ) { ?>
                						<section id="location">
									    	...
									    	<ul>
									    	    ...
									    	    <?php if (isset($woo_options['woo_contact_title']) && $woo_options['woo_contact_title'] != '' ) { ?><li><address><?php echo nl2br( esc_html( $woo_options['woo_contact_address'] ) ); ?></address></li><?php } ?>
									    	    <?php if (isset($woo_options['woo_contact_number']) && $woo_options['woo_contact_number'] != '' ) { ?><li class="tel"><?php echo esc_html( $woo_options['woo_contact_number'] ); ?></li><?php } ?>
									    	    ...
									    	    <?php if (isset($woo_options['woo_contactform_email']) && $woo_options['woo_contactform_email'] != '' ) { ?><li class="email"><a href="mailto:<?php echo esc_attr( $woo_options['woo_contactform_email'] ); ?>"><?php echo esc_html( $woo_options['woo_contactform_email'] ); ?></a></li><?php } ?>
									    	</ul>
										</section><!-- /.location -->
									<?php } ?>

									<?php if ( ( isset( $woo_options['woo_contact_twitter'] ) && $woo_options['woo_contact_twitter'] != '' ) || ( isset($woo_options['woo_contact_subscribe_and_connect']) && $woo_options['woo_contact_subscribe_and_connect'] == 'true' ) ) { ?>
								    	...
								    	<section id="twitter-connect">
								    		...
								    		<?php if ( isset( $woo_options['woo_contact_twitter'] ) && $woo_options['woo_contact_twitter'] != '' ) { ?>
								    		    <section id="twitter">
								    		    	<h2><?php _e( 'Twitter', 'woothemes' ); ?></h2>
								    		    	<ul id="twitter_update_list_123"><li></li></ul>
								    		    	<?php echo woo_twitter_script(123, $woo_options['woo_contact_twitter'],1); ?>
								    		    	<a class="follow-twitter" href="http://twitter.com/<?php echo $woo_options['woo_contact_twitter']; ?>" title="@<?php echo $woo_options['woo_contact_twitter']; ?>">@<?php echo $woo_options['woo_contact_twitter']; ?></a>
								    		    </section>
								    		<?php } ?>

											<!-- SOCIAL MEDIA -->

								    		<?php if ( isset($woo_options['woo_contact_subscribe_and_connect']) && $woo_options['woo_contact_subscribe_and_connect'] == 'true' ) { ?>

								    		    <section id="contact-social" <?php if ( isset( $woo_options['woo_contact_twitter'] ) && $woo_options['woo_contact_twitter'] != '' ) { ?>class="float"<?php } ?>>
